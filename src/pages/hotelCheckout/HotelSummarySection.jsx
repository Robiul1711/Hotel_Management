...
const HotelSummarySection = ({hotel}) => {
    return (
        <div className="md:p-8 p-4 rounded-[12px] bg-white shadow-xl w-full flex flex-col sm:flex-row justify-between gap-8">
            <div className="md:w-[70%] order-2 sm:order-1 flex flex-col ">
                <div className="flex items-start justify-between pb-3 sm:pb-6 border-b">
                    <div>
                        <h1 className="font-semibold text-xl md:text-[36px] mb-0">{hotel?.hotel_name}</h1>
                        <p className="text-[#999999] text-base md:text-xl mb-0">{hotel?.location}</p>
                    </div>
                ...
                <div className="flex flex-col xxs:flex-row items-start gap-3 xxs:items-center justify-between py-6">
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-start  gap-2">
                            <CheckInIcon />
                            <div className="flex flex-col">
                                <div className="font-semibold text-sm  md:text-lg">{hotel?.check_in}</div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-start  gap-2">
                            <CheckInIcon />
                            <div className="flex flex-col">
                                <div className="font-semibold text-sm  md:text-lg">{hotel?.check_out}</div>
                                <div className="text-[#999999] text-sm">(From 02:00 PM)</div>
                            </div>{" "}
                        </div>
                    </div>
                ...
                <div className="flex flex-col xxs:flex-row xxs:items-center gap-5 xxs:gap-10 sm:py-4">
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-start  gap-2">
                            ...
                            <div className="flex items-center  gap-3">
                                <div className="font-semibold text-sm  md:text-lg">{hotel?.total_room} Rooms</div>
                                <div className="w-px h-6 bg-[#999999]"></div>
                                <div className="font-semibold text-sm  md:text-lg">{hotel?.total_bath} Baths</div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-start  gap-2">
                            <GuestIcon />
                            <div className="flex items-center  gap-3">
                                <div className="font-semibold text-sm sm:text-base md:text-lg">{hotel?.total_room} Rooms</div>
                                <div className="w-px h-6 bg-[#999999]"></div>
                                <div className="font-semibold text-sm  md:text-lg">{hotel?.total_bath} Baths</div>
            ...
            <div className="sm:w-[30%] order-1 sm:order-2 flex flex-col items-center justify-center ">
                ...
                <img src={hotel?.thumbnail} alt="" className="w-full rounded-lg" />
            </div>
        </div>
    );
};
