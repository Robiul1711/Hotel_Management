...
const StaySearchBar = () => {
    ...
    return (
        <div className='absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 w-full xmd:px-4 z-30'>
            <div className=" xmd:w-11/12 mx-auto px-4">
                <div className="rounded-xl bg-[#f6f7f9] border p-2 md:p-8">
                    <div className="flex  flex-row items-center justify-between gap-3 sm:gap-4">
                        ...
                        {/* Check-in */}
                        <div className="hidden xmd:flex flex-col basis-[48%] sm:basis-auto">
