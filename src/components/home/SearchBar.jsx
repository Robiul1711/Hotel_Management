...
const popularDestinations = ["Lonavala", "Karjat", "Alibaug", "Palghar", "Goa"];
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="rounded-xl bg-white shadow-md p-4 md:p-6 lg:p-8 flex items-center justify-between flex-wrap gap-4">
          ...
          <div className="flex flex-col relative w-full sm:w-auto">
            <span className="text-sm md:text-lg text-black font-semibold mb-1">Destination</span>
          <Controller
  name="destination"
  control={control}
  render={({ field }) => (
    <Select {...field} value={field.value} onValueChange={(value) => setValue("destination", value)}>
...
/>
          ...
          <div className="flex flex-col basis-[48%] sm:basis-auto">
            <span className="text-sm md:text-lg text-black font-semibold mb-1">Check-in</span>
            <Controller
              name="checkIn"
              control={control}
              render={({ field }) => (
                <Popover>
                  <PopoverTrigger asChild>
                    <Input readOnly value={dayjs(field.value).format("DD MMM 'YY")} />
                  </PopoverTrigger>
          ...
          {/* Check-out */}
          <div className="flex flex-col basis-[48%] sm:basis-auto">
            <span className="text-sm md:text-lg text-black font-semibold mb-1">Check-out</span>
            <Controller
              name="checkOut"
              control={control}
              render={({ field }) => (
